...
save_folder = r'/media/le/Elements/halo/paper/figures/background_correction_all/stan/54/'
# file_list = glob.glob(r'/media/le/Elements/halo/classifier_new/32/*.nc')
file_list = glob.glob(r'/media/le/Elements/54/classified/*.nc')
...
for file in file_list:
    ...
    for t in avg['time']:
        ...
        ax[0].plot(np.mean(cross_fitted, axis=0), avg['range'], c='blue', label='fitted cross')
        ...
        ax[0].plot(np.mean(co_fitted, axis=0), avg['range'], c='red', label='fitted co')
        ...
        ax[1].errorbar(np.mean(cross_corrected, axis=0), avg['range'],
                       ...
                       c='blue', alpha=0.5)
        ax[1].set_xlabel('corrected cross-SNR')
        ...
        ax[2].set_xlabel('corrected co-SNR')
        ...
        ax[3].set_xlabel(r'$\delta$ (only Aerosol)')
